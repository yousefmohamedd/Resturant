                    ...
                    <form action="{{ route('meals.update', ['id'=>$meal->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div  class="mb3">
                            <label>Description Of Meal</label>
                                <textarea rows="4" name="description" class="form-control">{{ $meal->name }}</textarea>
                        </div><!--  Description -->
...
<div class="col-12">
<input type="number" name="medium_meal_price" value="{{ $meal->medium_meal_price }}"  class="form-control" placeholder="medium meal price">
</div>
<div class="col-12">
<input type="number" name="large_meal_price" value="{{ $meal->large_meal_price }}"  class="form-control" placeholder="large meal price">
</div>
</div><!-- price -->
...
<div class="mb3">
    ...
    <img src="{{ Storage::url($meal->image) }}" height="60" width="90" alt="">
</div><!--  Image -->
